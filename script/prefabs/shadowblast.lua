prefabs.shadowblast =
{
	display_name = "Shadowblast",
	description = "Launch a devastating torrent of shadow at your target, dealing very high damage",
	base_health = 99999,
	base_cooldown = 99999,
	base_damage = 10,
	movement_speed = 1.5,
...
prefabs.shadowblast.move_horizontal = prefabs.shadowblast.idle
