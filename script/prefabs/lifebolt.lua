prefabs.lifebolt =
{
	display_name = "Lifebolt",
	description = "Launch a bolt of life at a target, HEALING them",
	base_health = 99999,
	base_cooldown = 99999,
	base_damage = -5,
	movement_speed = 3,
	...
	on_update = function(me, delta)
		...
		-- so if our target ever changes then we must despawn, or the lifebolt will suddenly change trajectory.
...
prefabs.lifebolt.move_horizontal = prefabs.lifebolt.idle
